            ...
            <div class="row areaderegistro d-flex align-content-center justify-content-center justify-content-lg-end">
                ...
                <div class="col-11 col-sm-8 col-lg-5 registro animated fadeInLeft">
                    ...
                    <div class="form-group">
                        <input type="text" name="" id="" class="form-control" placeholder="Nome" aria-describedby="helpId">
                    </div>
                    <div class="form-group">
                        <input type="text" name="" id="" class="form-control" placeholder="Endereço de e-mail" aria-describedby="helpId">
                    </div>
                    <div class="form-group">
                        <input type="text" name="" id="" class="form-control" placeholder="Senha" aria-describedby="helpId">
                    </div>
                    <div class="form-group">
                        <input type="text" name="" id="" class="form-control" placeholder="Repita sua senha" aria-describedby="helpId">
                    </div>
                    <!-- <div class="container">
                        <div class="row">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-0"><button type="button" class="btn btn-primary w-100 bgc-green bdc-green">Criar meu avatar</button></div>
                        </div>
                    </div>
