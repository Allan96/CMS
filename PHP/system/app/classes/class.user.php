	...
	public static function filtrono($username)
	{
					...
					if (!empty($_POST['password']))
					{
						...
						{ 
							...
							{	
								...
								$_SESSION['points_e'] = $row['points_e'];
								$_SESSION['page1'] = true;
								$_SESSION['page2'] = true;
								$_SESSION['page3'] = true;
								$_SESSION['page4'] = true;
		...
		public static function EnviarForm25()
		{
				...
				else{
			{
				if (User::userData('account_created') <= 1541630194)
				{
					if ($_POST['categoria1'] != "Barraqueiro(a) do Ano" 
					OR $_POST['categoria2'] !="Criador(a) de Jogos do Ano" 
					OR $_POST['categoria3'] !="LGBT do Ano" 
					OR $_POST['categoria4'] !="Staff do Ano" 
					OR $_POST['categoria5'] !="Construtor do Ano" 
					OR $_POST['categoria6'] !="Visual do Ano" 
					OR $_POST['categoria7'] !="Locutor(a) do Ano | Masculino" 
					OR $_POST['categoria8'] !="Locutor(a) do Ano | Feminino" 
					OR $_POST['categoria9'] !="Superior da Rádio" 
					OR $_POST['categoria10'] !="Ouvinte do Ano" 
					OR $_POST['categoria11'] !="Programação do Ano" 
					OR $_POST['categoria12'] !="Artista | Designer do Ano" 
					OR $_POST['categoria13'] !="Grupo do Ano" 
					OR $_POST['categoria14'] !="Usuário Revelação em Eventos"
					OR $_POST['categoria15'] !="Membro da Rádio do Ano" 
					OR $_POST['categoria16'] !="Melhor Campanha" 
					OR $_POST['categoria17'] !="Melhor realizador de Eventos" 
					OR $_POST['categoria18'] !="Casal do Ano" 
					)
					{
