<?php
	...
	*/
	...
	$lang["Rback"] = "Back";
	$lang["RCopyright"] = "Copyright 2016~2018 ".$config['hotelName']." Hotel. Todos direitos reservados.";
	...
	$lang["referi"] = "Já existe um IP cadastrado neste referido, cadastre-se por <a href='/register'>AQUI</a>";
	...
	$lang["Nnews"] = "Newsmessages";
	$lang["Ntoday"] = "Hoje";
	$lang["Nyesterday"] = "Ontem";
	$lang["Nthisweek"] = "Esta semana";
	$lang["Nlastweek"] = "Semana passada";
	$lang["Nthismonth"] = "Este mês";
	$lang["Nlastmonth"] = "Mês passado";
	$lang["Nnotfoundheader"] = "Noticia não encontrada";
	$lang["Nnotfoundtxt"] = "Escolha umas das noticias no menu ao lado!";
	...
	//Login-----------------------------------------------------------------------------------------------
	$lang["Lpasswordwrong"] = "A senha não está correta!";
	$lang["Lnotexistuser"] = "Este nome de usuário não existe!";
	$lang["Lnopassword"] = "Você não preencheu o campo da senha";
	$lang["Lnousername"] = "Você não preencheu o campo de nome";
	$lang["Lwrong"] = "Something has gone wrong!";
	
	//Register--------------------------------------------------------------------------------------------
	$lang["Rmaxaccounts"] = "Sorry but you can't register a new account on this ip!";
	$lang["Rpasswordswrong"] = "As senhas não coincidem!";
	$lang["Rpasswordshort"] = "A senha deve conter pelo menos 6 caracteres!";
	$lang["Remailexists"] = "Este e-mail já existe!";
	$lang["Rusernameused"] = "O nome de usuário já existe, tente outro.";
	$lang["Remailnotallowed"] = "Email is not allowed!";
	$lang["Remailempty"] = "Eeail is empty!";
	$lang["Rpasswordsempty"] = "As senhas não coincidem";
	$lang["Rusernameshort"] = "Seu username deve conter entre 3 e 13 caracteres! Sem caracteres especiais!";
	...
	//Edit password---------------------------------------------------------------------------------------
	$lang["Ppasswordchanges"] = "Senha alterada com sucesso!!";
	$lang["Pnotwork"] = "Did not work!";
	$lang["Ppasswordshort"] = "Sua senha precisa de mais de 6 caracteres";
	$lang["Poldpasswordwrong"] = "Sua senha antiga está incorreta!";
	...
	//Like news-------------------------------------------------------------------------------------------
	$lang["LoneTime"] = "Você só pode votar 1 vez!!";
	$lang["LnewsLike"] = "Você acabou de votar nesta noticia =)";
	$lang["LnoNews"] = "Esta noticia não existe";
	...
	//Change username-------------------------------------------------------------------------------------
	$lang["Cusernameshort"] = "Seu nome deve conter entre 3 á 13 caracteres!";
	$lang["Cusernameused"] = "Seu nome já está sendo usado!";
	$lang["Cchangeno"] = "Você não pode mais mudar seu nome!";
	
	//Forgot Password-------------------------------------------------------------------------------------
	$lang["FemailIsSend"] = "Foi enviado ao seu e-mail a redefinição de senha! Verifique sua caixa de entrada/spam";
	$lang["FkeyError"] = "Este código não existe ou já foi usado!";
	$lang["FnoEmailUser"] = "Não foi encontrado nenhum usuário com este endereço de e-mail";
	$lang["FPasschange"] = "Senha trocada!";
	$lang["Femailempty"] = "O campo da senha está vazio!";
	$lang["Fpasswordsempty"] = "As senhas não coincidem!";
	$lang["Fpasswordshort"] = "A senha precisa de pelo menos 6 caracteres!";
	$lang["Femailempty"] = "O campo de Key está vázio!!";
